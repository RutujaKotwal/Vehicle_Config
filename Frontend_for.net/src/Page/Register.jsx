        ...
        <div className="container">
          <div className="container1 container-class">
            ...
            <div className="label-input-pair">
              ...
              <input type="text" name="compName" id="compName" onChange={handleChange} placeholder="Enter your company name" required />
            </div>
            <div className="label-input-pair">
          ...
          <div className="container2 container-class">
            ...
            <div className="label-input-pair">
              ...
              <input type="text" name="nameAuthPerson" id="nameAuthPerson" onChange={handleChange} placeholder="Enter name of authorized person" required />
            </div>
            <div className="label-input-pair">
          ...
          <div className="container3 container-class">
            <div className="label-input-pair">
              ...
              <input type="tel" name="authTel" id="authTel" onChange={handleChange} placeholder="Enter authorized telephone number" required pattern="[0-9]{10}" title="Enter valid 10-digit telephone number" />
            </div>
            <div className="label-input-pair">
              <label htmlFor="auth_cell">Authorized Cell:</label>
              <input type="tel" name="authCell" id="authCell" onChange={handleChange} placeholder="Enter authorized cell number" required pattern="[0-9]{10}" title="Enter valid 10-digit cell number" />
            </div>
            <div className="label-input-pair">
              <label htmlFor="comp_st_no">Company ST Number:</label>
              <input type="text" name="compStNo" id="compStNo" onChange={handleChange} placeholder="Enter company ST number" required />
            </div>
            <div className="label-input-pair">
              <label htmlFor="vat_no">VAT Number:</label>
              <input type="text" name="vatNo" id="vatNo" onChange={handleChange} placeholder="Enter VAT number" required />
            </div>
          </div>
        </div>
